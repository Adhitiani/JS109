...
1. Hashmap
2. Unique loop
3. String/Collection split
4. String/Collection 'class' split
*/


// creating a hashmap
// Problem needs some kind of uniques? does it need to know occurences? 
function hashmap(collection) {
  ...
  // returns KVP with keys being characters, values being # occurences
