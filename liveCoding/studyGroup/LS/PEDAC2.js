...
Input: 
  - string comprised of alphanumeric characters and spaces
Output:
  -number (sum of the numbers inside the input string)
Rules:
  -input string may only include positive numbers
  -input string might contain lowercase/uppercase letters, spaces, digits
  -consecutive digits should be treated as one number
  -ignore all characters that are not digits

Questions:
  -can the input string include any other types of characters?
